...
if __name__ == '__main__':
    ...
    cricfile = codecs.open("E:\\Department\\MscIT_Sem_III_and sem I nov 2020\\NLP\\cricketbat.txt", 'r', "utf-8")
    sent2 = cricfile.read().lower()
    vampirefile = codecs.open("E:\\Department\\MscIT_Sem_III_and sem I nov 2020\\NLP\\vampirebat.txt", 'r', 'utf-8')
